class DessertsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to desserts_path, status: :see_other, notice: "Dessert was successfully destroyed." }
  ...
  private
    ...
    def dessert_params
      params.require(:dessert).permit(:name, :description, :price, :image)
    end
end
